...
export default function AdminUsers() {
  ...
  const updateRoleMutation = trpc.admin.updateUserRole.useMutation({
    onSuccess: () => {
      toast.success(language === "ar" ? "تم تحديث صلاحيات المستخدم" : "User role updated");
      refetch();
    }
  });
        ...
        <Card>
          <CardHeader>
            <div className="relative">
              ...
              <Input
                placeholder={language === "ar" ? "بحث عن مستخدم بالاسم أو البريد..." : "Search users by name or email..."}
                className="pl-10"
                value={search}
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-right">{language === "ar" ? "تغيير الدور" : "Change Role"}</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {users?.map((user: any) => (
