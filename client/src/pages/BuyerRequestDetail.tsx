...
export default function BuyerRequestDetail() {
  ...
  const { data: quotes, isLoading: quotesLoading } =
    trpc.inquiries.getQuotes.useQuery({ requestId: Number(id) });
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="bg-gray-50 p-4 rounded-md mb-4">
                        ...
                        <p className="text-sm text-gray-600">
                          {quote.terms || "No specific terms provided."}
                        </p>
                      </div>
                      <Button
          ...
          <div className="space-y-6">
            <Card className="bg-blue-600 text-white">
              <CardHeader>
                <CardTitle className="text-lg">
                  {language === "ar" ? "كيف يعمل الدفع؟" : "How Payment Works"}
                </CardTitle>
              </CardHeader>
            ...
            <Card>
              ...
              <CardContent>
                <ChatSkeleton
                  recipientName={
                    language === "ar" ? "دعم المصنع" : "Factory Support"
                  }
                />
              </CardContent>
            </Card>
