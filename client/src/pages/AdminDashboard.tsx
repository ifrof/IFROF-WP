...
export default function AdminDashboard() {
  ...
  // Rule of Hooks: Call ALL hooks at the top level, always in the same order.
  ...
  // Return a single consistent structure to avoid re-render hook mismatches
  return (
    <div className="min-h-screen bg-slate-50 p-4 md:p-8">
      {(loading || statsQuery.isLoading) ? (
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
           <p className="text-red-500 font-bold">Access Denied / Redirecting...</p>
        </div>
      ) : (
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="border-none shadow-sm overflow-hidden">
              ...
              <CardContent>
                <div className="text-3xl font-black text-slate-900">{statsQuery.data?.stats?.products || 0}</div>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-sm overflow-hidden">
              ...
              <CardContent>
                <div className="text-3xl font-black text-slate-900">{statsQuery.data?.stats?.orders || 0}</div>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-sm overflow-hidden">
              ...
              <CardContent>
                <div className="text-3xl font-black text-slate-900">{statsQuery.data?.stats?.users || 0}</div>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-sm overflow-hidden">
              ...
              <CardContent>
                <div className="text-3xl font-black text-slate-900">${(statsQuery.data?.stats?.revenue || 0).toLocaleString()}</div>
              </CardContent>
            </Card>
          </div>
        </div>
