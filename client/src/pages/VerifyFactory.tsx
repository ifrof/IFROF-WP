    ...
    <div className="container mx-auto py-12 px-4 max-w-4xl">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-600 text-lg">
          Instantly verify if a Chinese supplier is a real direct manufacturer
          or just a trading company.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <Card className="md:col-span-1 h-fit">
          <CardHeader>
            ...
            <CardDescription>
              Enter factory details for AI analysis
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="factory_name"
                    placeholder="e.g. Foshan Furniture Co."
                    className="pl-10"
              ...
              <Button
                type="submit"
                className="w-full bg-[#1e3a5f] hover:bg-[#2a5282]"
          ...
          {!report && !verifyMutation.isPending && !error && (
            <div className="bg-gray-50 border-2 border-dashed border-gray-200 rounded-xl p-12 text-center">
              ...
              <p className="text-gray-400">
                Fill out the form to start the AI verification process.
              </p>
            </div>
          )}
          ...
          {verifyMutation.isPending && (
            <div className="bg-white border rounded-xl p-12 text-center shadow-sm">
              ...
              <p className="text-gray-500">
                Searching official records, Alibaba profiles, and business
                licenses across the web.
              </p>
            </div>
          )}
            ...
            <Card className="border-t-4 border-t-blue-600 shadow-lg">
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <Badge
                    variant={report.is_verified ? "default" : "destructive"}
                    className={report.is_verified ? "bg-green-600" : ""}
                  >
                    {report.is_verified
                      ? "VERIFIED FACTORY"
                      : "CAUTION ADVISED"}
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    {report.evidence.map((item: any, i: number) => (
                      <li
                        key={i}
                        className="bg-gray-50 p-3 rounded-lg border-l-4 border-l-blue-400"
                      >
