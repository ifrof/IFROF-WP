...
const pageTranslations = {
  ar: {
    ...
    poweredByAI: 'Kill the Middleman - تجاوز الوسطاء',
    ...
    aiAnalysis: 'تحليل الذكاء الاصطناعي العميق',
    ...
    accurateVerificationDesc: 'نستخدم الذكاء الاصطناعي لكشف الشركات التي تدعي أنها مصانع وهي مجرد مكاتب تجارية.',
  ...
  en: {
    ...
    poweredByAI: 'Kill the Middleman - No More Commissions',
    ...
    comprehensiveSearch: 'Kill the Middleman',
    ...
    accurateVerificationDesc: 'Our AI detects companies claiming to be factories when they are just trading offices.',
