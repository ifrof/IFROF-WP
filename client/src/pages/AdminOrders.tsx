        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              {language === "ar" ? "متابعة وتحديث حالات طلبات العملاء" : "Track and update customer order statuses"}
            </p>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <Select value={statusFilter} onValueChange={setStatusFilter}>
              ...
              <SelectContent>
                <SelectItem value="all">{language === "ar" ? "الكل" : "All Statuses"}</SelectItem>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>{language === "ar" ? "تحديث الحالة" : "Update Status"}</TableHead>
