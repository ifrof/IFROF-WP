...
export default function FAQ() {
  ...
  const faqs = [
    ...
    {
      question: language === "ar" ? "كيف يتم التحقق من المصانع؟" : "How are factories verified?",
      answer: language === "ar"
  ...
  const seo = {
    title: language === 'ar' ? 'الأسئلة الشائعة | IFROF' : 'FAQ - Frequently Asked Questions | IFROF',
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: language === 'ar' ? 'الأسئلة الشائعة' : 'FAQ', url: 'https://ifrof.com/faq' }
      ]} />
      <Helmet>
