...
export default function BuyerDashboard() {
  ...
  const getStatusBadge = (status: string) => {
    const statusMap: Record<string, { variant: any; label: string }> = {
      pending: { variant: "secondary", label: t("importRequest.status.pending") },
      confirmed: { variant: "default", label: t("importRequest.status.approved") },
      processing: { variant: "default", label: t("importRequest.status.inProgress") },
      shipped: { variant: "default", label: t("importRequest.status.shipped") },
      delivered: { variant: "default", label: t("importRequest.status.completed") },
      cancelled: { variant: "destructive", label: t("importRequest.status.cancelled") },
    };
    ...
    <BuyerDashboardLayout>
      <div className="space-y-8">
          ...
          <Link href="/import-request">
            <Card className="cursor-pointer hover:shadow-lg transition-shadow">
              <CardContent className="pt-6 text-center">
                ...
                <h3 className="font-medium">{t("dashboard.buyer.newImportRequest")}</h3>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href="/factory">
            <Card className="cursor-pointer hover:shadow-lg transition-shadow">
              <CardContent className="pt-6 text-center">
                ...
                <h3 className="font-medium">{t("dashboard.buyer.browseProducts")}</h3>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href="/factory-investigator">
            <Card className="cursor-pointer hover:shadow-lg transition-shadow">
              <CardContent className="pt-6 text-center">
                ...
                <h3 className="font-medium">{t("dashboard.buyer.smartAssistant")}</h3>
              </CardContent>
            </Card>
          </Link>
        </div>
        ...
        <Tabs defaultValue="orders" className="space-y-4">
          <TabsList>
            <TabsTrigger value="orders">{t("dashboard.buyer.orders")}</TabsTrigger>
            <TabsTrigger value="inquiries">{t("dashboard.buyer.inquiries")}</TabsTrigger>
          </TabsList>
              ...
              <CardContent>
                {inquiriesLoading ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-muted-foreground mb-4">{t("dashboard.buyer.noInquiries")}</p>
                    <Link href="/import-request">
