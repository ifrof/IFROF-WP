...
export default function BuyerDashboardLayout({
  ...
  return (
    ...
    >
      <BuyerDashboardLayoutContent setSidebarWidth={setSidebarWidth}>
        {children}
      </BuyerDashboardLayoutContent>
    </SidebarProvider>
  );
}

type BuyerDashboardLayoutContentProps = {
  children: React.ReactNode;
  setSidebarWidth: (width: number) => void;
};

function BuyerDashboardLayoutContent({
  children,
  setSidebarWidth,
}: BuyerDashboardLayoutContentProps) {
