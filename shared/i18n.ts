 ...
 * Supports Arabic (ar), English (en), and Simplified Chinese (zh)
 */
...
export const translations = {
  ar: {
    ...
    smartAssistant: {
      ...
      searchButton: 'بحث',
      clearButton: 'مسح',
      factoryFound: 'مصنع تم العثور عليه',
      factoriesFound: 'مصانع تم العثور عليها',
  ...
  en: {
    ...
    dashboard: {
      ...
      buyer: {
        ...
        kycDescription: 'Please complete KYC verification to access all features',
  ...
  zh: {
    ...
    hero: {
      ...
      title: '直接从中国工厂进口',
      titleHighlight: '无中间商',
      subtitle: '我们直接连接您与经过验证的中国制造商。我们使用AI验证每家工厂，确保它是直接制造商，而非中间商。',
      cta: '开始进口申请',
      ctaSecondary: '了解运作方式',
      stats: {
    ...
    // Footer
    footer: {
      description: 'IFROF平台直接连接买家与经过验证的中国制造商。我们消除中间商，为您保证最优价格。',
      quickLinks: '快速链接',
      legal: '法律',
      contact: '联系我们',
      terms: '条款和条件',
