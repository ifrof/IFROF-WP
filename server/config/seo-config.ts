...
export const staticPagesSEO: Record<string, PageSEO> = {
  '/': {
    ...
    descriptionAr: 'تواصل مباشرة مع المصانع الصينية الموثقة. استورد منتجات عالية الجودة بأسعار المصنع. بدون وسطاء، تسعير شفاف، ومعاملات آمنة.',
    keywordsAr: ['مصانع صينية', 'استيراد من الصين', 'جملة', 'منصة B2B', 'سعر المصنع']
  },
  '/marketplace': {
    ...
    descriptionAr: 'تصفح سوقنا للمصنعين الصينيين الموثقين في جميع الصناعات. اتصالات مباشرة بالمصانع وأسعار تنافسية.',
    keywordsAr: ['سوق المصنعين', 'موردين صينيين', 'دليل المصانع', 'مصانع موثقة']
  },
  '/search': {
    title: 'Search Products - Find Factory Direct Items | IFROF',
    description: 'Search for products directly from Chinese factories. Filter by category, price, and MOQ.',
    keywords: ['product search', 'factory direct products', 'china wholesale search'],
    ogImage: DEFAULT_OG_IMAGE,
    canonical: `${BASE_URL}/search`,
    titleAr: 'بحث عن منتجات - ابحث عن سلع مباشرة من المصنع | إيفروف',
    descriptionAr: 'ابحث عن منتجات مباشرة من المصانع الصينية. تصفية حسب الفئة والسعر والحد الأدنى للطلب.',
    keywordsAr: ['بحث منتجات', 'منتجات مصنع مباشرة', 'بحث جملة الصين']
  },
  '/buyer/requests': {
    title: 'My Import Requests - Buyer Dashboard | IFROF',
    description: 'Manage your import requests and view quotes from Chinese manufacturers.',
    ...
    descriptionAr: 'إدارة طلبات الاستيراد الخاصة بك وعرض عروض الأسعار من المصانع الصينية.',
