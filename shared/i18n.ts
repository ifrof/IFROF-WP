...
export const translations = {
  ar: {
    ...
    smartAssistant: {
      ...
      subtitle:
        "يساعدك في العثور على المصانع الصينية الموثقة والتحقق من أنها مصانع مباشرة",
  ...
  en: {
    ...
    smartAssistant: {
      ...
      subtitle:
        "Helps you find verified Chinese manufacturers and verify they are direct factories",
